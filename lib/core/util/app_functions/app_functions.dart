...
class AppFunctions{
  ...
  static navigateTo({required context,required navigatedScreen})=>Navigator.push(
      context,
      MaterialPageRoute(builder: (context)=>navigatedScreen));
  static navigateAndFinishTo({required context,required navigatedScreen})=>Navigator.pushAndRemoveUntil(
    context,
    MaterialPageRoute(builder: (context)=>navigatedScreen),(route) => false,);
